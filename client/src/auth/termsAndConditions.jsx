...
export default function TermsAndConditions({handleTermsAccept}) {
  ...
  return (
    <DialogContent>
        ...
        <div className="bg-zinc-100 p-8 rounded-lg shadow-lg">
            ...
            <section>
                <h2 className="text-xl font-semibold mb-2">2. Data Handling & Privacy</h2>
                <ul className="list-disc ml-6 text-gray-700">
            ...
            <section>
                <h2 className="text-xl font-semibold mb-2">5. Disclaimers & Limitation of Liability</h2>
                <ul className="list-disc ml-6 text-gray-700">
