...
export default function PrivacyPolicy({handlePrivacyAccept}) {
  return (
    <DialogContent>
        <DialogHeader>
...
handle your data when you use our intelligent document processing platform ("Service").</p>
            ...
            <section>
                <h2 className="text-xl font-semibold mb-2">2. Data Processing</h2>
                <ul className="list-disc ml-6 text-gray-700">
...
Any disputes arising from this policy will be resolved in San Diego, California.</p>
        ...
        <DialogFooter>
        <Button onClick={handlePrivacyAccept}>Accept</Button>
        </DialogFooter>
    </DialogContent>
  )
}
